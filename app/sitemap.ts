...
export default async function sitemap(): Promise<MetadataRoute.Sitemap> {
  ...
  const staticRoutes: MetadataRoute.Sitemap = [
    ...
    { url: `${SITE_URL}/quesos-italianos`, lastModified: now, changeFrequency: "weekly", priority: 0.85 },
    { url: `${SITE_URL}/vinos-italianos`, lastModified: now, changeFrequency: "weekly", priority: 0.85 },
    ...
    { url: `${SITE_URL}/marca`, lastModified: now, changeFrequency: "monthly", priority: 0.8 },
    ...
    { url: `${SITE_URL}/como-comprar`, lastModified: now, changeFrequency: "monthly", priority: 0.7 },
  ];
  ...
  try {
    ...
    brandRoutes = BRANDS.filter((b) => matchBrandProducts(b, products).length >= 2).map((b) => ({
