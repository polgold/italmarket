...
export const proseccoDocDocg: Guide = {
  slug: "prosecco-doc-docg-diferencias",
  title: "Prosecco: DOC, DOCG, Superiore y Valdobbiadene",
  summary:
  ...
  sections: [
    ...
    {
      heading: "DOC vs DOCG: la jerarquía",
      body: [
    ...
    {
      heading: "Valdobbiadene y Cartizze: la cima",
      body: [
    ...
    {
      heading: "Extra brut, brut, extra dry, dry: el azúcar residual",
      body: [
    ...
    {
      heading: "Cómo servir y con qué acompañarlo",
      body: [
    ...
    {
      heading: "Cuándo vale la pena pagar más",
      body: [
