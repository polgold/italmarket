...
export const aceiteOlivaExtraVirgen: Guide = {
  slug: "como-elegir-aceite-de-oliva-extra-virgen",
  title: "Cómo elegir un aceite de oliva extra virgen",
  summary:
  ...
  sections: [
    {
      heading: "¿Qué significa «extra virgen»?",
      body: [
    ...
    {
      heading: "Los tres perfiles de AOVE",
      body: [
    ...
    {
      heading: "Cuándo usar AOVE en crudo y cuándo cocinar",
      body: [
