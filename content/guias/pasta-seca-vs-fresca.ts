import type { Guide } from "@/lib/recipes/types";

export const pastaSecaVsFresca: Guide = {
  slug: "pasta-seca-vs-fresca",
  title: "Pasta seca vs pasta fresca: cuándo usar cada una",
  summary:
  ...
  readTimeMin: 5,
  keywords: [
    "pasta seca vs fresca",
    "pasta seca italiana",
    "pasta fresca al huevo",
    "diferencias pasta seca fresca",
    "qué pasta usar",
    "pasta italiana tipos",
  ],
  ...
  sections: [
    {
      heading: "De qué está hecha cada una",
      body: [
    ...
    {
      heading: "Qué pasta va con qué salsa",
      body: [
    ...
    {
      heading: "Cómo guardar y conservar",
      body: [
    ...
    {
      heading: "Marcas italianas recomendadas",
      body: [
